(function () {
    ...
    if(logo.length) {
      ...
      if (ud_header.classList.contains("sticky")) {
        document.querySelector(".header-logo").src =
          "assets/images/prime/logo.png?v=2"
      } else {
        document.querySelector(".header-logo").src =
          "assets/images/prime/logo.png?v=2"
      }
    ...
    form.addEventListener("submit", async (event) => {
      ...
      if (submitButton) {
        ...
        if (submitButton.tagName === "INPUT") {
          submitButton.value = loadingButtonText;
        } else {
  ...
  // ===== blog subscribe form
  wireAsyncForm({
    formSelector: "#blogSubscribeForm",
    statusSelector: "#blogSubscribeStatus",
    submitSelector: 'input[type="submit"]',
    endpoint: "/api/blog-subscribe",
    loadingMessage: "Submitting your subscription...",
    loadingButtonText: "Submitting...",
    successFallback: "Thanks. You are subscribed successfully.",
    errorFallback: "Sorry, we could not process your subscription right now.",
  });
})();
